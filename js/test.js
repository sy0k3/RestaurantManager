...
function testRestaurantManager() {
  ...
  let d1 = new Dish(
    "Pulpo a la Gallega",
    "El “pulpo á feira” es un plato que consta de pulpo cocido, el cual se corta en láminas y se coloca, preferiblemente, en un plato de madera, añadiéndole sal gruesa, pimentón y aceite de oliva. ",
  ...
  let ca2 = new Category("Ensaladas");
  let ca3 = new Category("Sopas");
  let ca4 = new Category("Postre");
  testCategory();
  ...
  let m3 = new Menu("Diario");
  let m4 = new Menu("Mar y Montaña");
  testMenu();
